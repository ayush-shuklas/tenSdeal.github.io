          ...
          <div class="slider-caption">
               <div class="portfolio-desc">
                    ...
                    <p class="typer wow fadeInLeft" data-wow-delay="1.3s" data-typer-targets = "<?php echo esc_html(get_theme_mod('parallax_subheading_one','I Know WordPress Theme Development'));?><br />
                         ...
                         <?php echo esc_html(get_theme_mod('parallax_subheading_three','I Know WordPress Support'));?><br /><?php echo esc_html(get_theme_mod('parallax_subheading_four','I Know WordPress Theme Design'));?><br /><?php echo esc_html(get_theme_mod('parallax_subheading_five','I Know WordPress Theme Design'));?>" data-deleteDelay="1000">
                    </p>
                    <?php } else { ?>
